            ...
            <div className="flex items-center gap-2 md:gap-4">
              {currentUser.role === UserRole.CLIENT && (
                <button 
                  ...
                  className="px-3 md:px-4 py-2 md:py-2.5 bg-rose-600 text-white rounded-xl font-black text-[9px] md:text-[10px] uppercase tracking-widest shadow-lg shadow-rose-200 hover:bg-rose-700 transition-all flex items-center gap-2 animate-pulse"
                >
                  <i className="fa-solid fa-triangle-exclamation"></i>
                  <span className="hidden xs:inline">Panic</span>
                </button>
              )}
              ...
              <div className="flex items-center gap-1 md:gap-2">
                <button 
                  ...
                  className={`w-8 h-8 md:w-10 md:h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:${themeClasses.text} hover:${themeClasses.border.replace('border-', 'border-')} transition-all hidden sm:flex`}
                  title={isFullscreen ? "Exit Full Screen" : "Enter Full Screen"}
                >
                  <i className={`fa-solid ${isFullscreen ? 'fa-compress' : 'fa-expand'}`}></i>
                </button>
                <button className={`w-8 h-8 md:w-10 md:h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:${themeClasses.text} hover:${themeClasses.border.replace('border-', 'border-')} transition-all`}>
