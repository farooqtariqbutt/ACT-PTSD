...
const THERAPY_SESSIONS = [
  ...
  { 
    ...
    moduleKey: 'acc',
    steps: [
      { id: 'intro', title: 'Welcome Back', type: 'intro', content: "Welcome back! I hope you’ve had a good week. Find a position that feels comfortable for your body. Choose a place where you feel safe and have as few distractions as possible. If at any point you feel uncomfortable, you can adjust your position or pause." },
      { id: 'check-in', title: 'Check-in on Practice', type: 'questionnaire', questions: [
          { id: 'practice_review', text: "Last week, we practiced the ‘Dropping the Anchor’ exercise. Can you tell me when and where you did it? Did you notice any changes in your body, mind, or emotions while doing it?", type: 'text' }
      ]},
      { id: 'inner-world', title: 'Acknowledge your Inner World', type: 'questionnaire', questions: [
  ...
  { 
    ...
    moduleKey: 'val',
    steps: [
      { id: 'intro', title: 'Welcome', type: 'intro', content: "Hello! I’m really glad to see you today. You have been putting effort into this process, and that is important. Every step you take, even small ones, shows growth. Today, we will continue building on the progress you’ve already made." },
      { id: 'check-in', title: 'Check-in on Practice', type: 'questionnaire', questions: [
          { id: 'practice_review_s5', text: "While practicing the Chessboard or Sky and Weather exercise, what thoughts and feelings did you notice, and did reminding yourself that you are the observer (not your thoughts or feelings) make any difference?", type: 'text' }
      ]},
      { id: 'choose-domains', title: 'Life Domains', type: 'exercise', content: "Values are about how you want to behave as a person. They are not about what you want to achieve, but about how you want to treat yourself, others, and the world.\n\nFirst, tap the domains of your life that have been disrupted by PTSD." },
      { id: 'rate-values', title: 'Values Rating', type: 'exercise', content: "Now, choose one area of your life you want to improve. Read the list of values and rate each one:\n\nV = Very important\nQ = Quite important\nN = Not so important" },
      { id: 'card-sort', title: 'Values Card Sort', type: 'exercise', content: "Your 'Very Important' values are shown below. Drag and reorder them based on your priorities for the life area you selected. Place the most important at the top." },
      { id: 'last-day-reflection', title: 'Last Day Reflection', type: 'questionnaire', questions: [
          { id: 'last_day_thought', text: "Imagine this is your last day. What would matter most?", type: 'text' }
      ]},
      { id: 'avoided-domain', title: 'Blocked Areas', type: 'questionnaire', questions: [
          { id: 'blocked_domain', text: "Which area of your life feels most blocked by trauma?", type: 'text' }
      ]},
      { id: 'small-step', title: 'Identify a Small Step', type: 'questionnaire', questions: [
          { id: 'tiny_step', text: "Pick one tiny value-based step you can take today. (e.g., sending a kind message, speaking honestly, practicing patience, taking care of your health)", type: 'text' }
      ]},
      { id: 'action-log', title: 'Values Action Log', type: 'exercise', content: "This is your log to track your value-based actions." },
      { id: 'closing', title: 'Session Wrap-up', type: 'closing', content: "Homework: This week, take one small step every day based on the value you selected. After each step, write it in your Values Action Log." }
    ]
  },
  { 
    number: 6, 
    ...
    steps: [
      ...
      { id: 'questions-6', title: 'Domain Importance', type: 'questionnaire', questions: [
  ...
  { 
    ...
    steps: [
      { id: 'intro', title: 'Welcome', type: 'intro', content: "Hello! I’m really glad to see you today. You have been putting effort into this process, and that is important. Every step you take, even small ones, shows growth. Today, we will continue building on the progress you’ve already made." },
      { id: 'reflection-s7', title: 'Reflection', type: 'questionnaire', questions: [
          { id: 'value_focus_last_week', text: "Last week, you were supposed to take small actions to live according to your values. Which value did you focus on, and what action did you take to live that value?", type: 'text' },
          { id: 'action_reflection', text: "How did taking this action make you feel, and what did you learn about yourself?", type: 'text' }
      ]},
      { id: 'value-selection-s7', title: 'Focus Area', type: 'exercise', content: "Which area and value will you focus on today? Choose from the values and life domains you identified previously." },
      { id: 'smart-goal-builder', title: 'SMART Goal Builder', type: 'exercise', content: "Let's turn your value into a specific, small step using the SMART framework." },
      { id: 'barriers-s7', title: 'Anticipate Barriers', type: 'exercise', content: "What thoughts, feelings, or triggers might get in the way of your goal?" },
      { id: 'choice-point-s7', title: 'The Choice Point', type: 'exercise', content: "In any challenging situation, we have a choice: move 'Towards' the person we want to be, or 'Away' from them." },
      { id: 'closing', title: 'Session Wrap-up', type: 'closing', content: "Homework: This week, take one small step every day based on the value you selected. After each step, write it in your Values Action Log." }
    ]
  },
  { 
    ...
    steps: [
      ...
      { id: 'questions-8', title: 'Exposure Planning', type: 'questionnaire', questions: [
  ...
  { 
    ...
    steps: [
      ...
      { id: 'questions-9', title: 'Growth & Resilience', type: 'questionnaire', questions: [
  ...
  { 
    ...
    steps: [
      ...
      { id: 'questions-10', title: 'Compassion Check', type: 'questionnaire', questions: [
  ...
  { 
    ...
    steps: [
      ...
      { id: 'questions-11', title: 'Restoring Values', type: 'questionnaire', questions: [
  ...
  { 
    ...
    steps: [
      ...
      { id: 'questions-12', title: 'Future Commitment', type: 'questionnaire', questions: [
