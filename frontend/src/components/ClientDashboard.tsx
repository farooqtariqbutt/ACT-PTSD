          ...
          <div className="flex-1 w-full">
              ...
              <div>
                ...
                {hasCompletedAssessments && currentSessionNumber <= 12 && (
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">
                    Next Session: {isTodayValid ? 'Available Today' : `Schedule (${scheduleLabel})`}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className={`grid gap-1.5`} style={{ gridTemplateColumns: `repeat(${totalPrescribed}, minmax(0, 1fr))` }}>
                {prescribedSessions.sort((a: number, b: number) => a - b).map((n: number) => (
                  <div
                    key={n}
          ...
          <div className="flex flex-col gap-3 w-full lg:w-auto mt-4 lg:mt-0">
            <button
              onClick={() => {
                ...
                else if (currentSessionNumber > 12) navigate('/assessments?type=post');
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section className="lg:col-span-2 space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center px-2">
              <h3 className="font-bold text-slate-800 flex items-center gap-2">
                <i className={`fa-solid fa-person-running ${themeClasses.text}`} />
                Committed Actions
              </h3>
              <NavLink
                to="/values-log"
